<div class="card-body">
    <h2 class="font-bold text-gray-600 card-title"><span class="text-gray-500">Kemaskini Bahagian</span>
    ...
    @if ($staff_section)
        ...
        <div class="flex justify-between w-full mb-3">
            ...
            <p class="flex-grow-0 text-gray-700"><span class="font-bold">Staff, unit, log kerja</span> berkaitan dengan bahagian ini akan dibuang.</p>
        </div>

        <button class="ml-auto btn btn-error w-60" onclick="delete_section_modal.showModal()">
            Buang Bahagian
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="-mt-0.5 size-5">
        ...
        <dialog id="delete_section_modal" class="modal" wire:ignore.self>
            <div class="modal-box">
                ...
                <h3 class="mt-3 mb-1 text-lg font-bold text-center">Buang bahagian?</h3>
                ...
                <div class="flex items-center justify-center gap-2 modal-action">
                    ...
                    <button wire:click='delete' class="btn btn-error">Buang Bahagian</button>
                </div>
            </div>
        </dialog>
    @else
